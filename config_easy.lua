function CfgDifficulty()
	...
	CfgWarriorClass(0, 105, 190, 150, 212, 110, 170, 1, 1, 2, 2, 2, 2, 2);
	CfgWarriorClass(1, 105, 180, 120, 172, 100, 168, 1, 1, 2, 2, 2, 2, 2);
	CfgWarriorClass(2, 75, 170, 120, 172, 100, 168, 2, 1, 2, 2, 2, 2, 2);
	CfgWarriorClass(3, 70, 150, 120, 166, 80, 156, 2, 1, 2, 1, 2, 2, 1);
	CfgWarriorClass(4, 70, 150, 150, 154, 100, 240, 2, 1, 2, 1, 2, 2, 2);
	CfgWarriorClass(5, 85, 160, 100, 154, 90, 240, 2, 1, 2, 2, 1, 2, 2);
	CfgWarriorClass(6, 70, 150, 78, 154, 200, 240, 2, 1, 1, 1, 2, 2, 2);
	CfgWarriorClass(7, 80, 170, 120, 166, 100, 168, 1, 1, 2, 2, 1, 2, 2);
	CfgWarriorClass(8, 95, 180, 96, 154, 70, 132, 1, 1, 2, 2, 2, 2, 2);
	
	CfgPowerClass(58, 650, 110, 80, 20, 2000, 200, 300, 1.2, 0.25, 1, 1, 1, 1, 0.75, 3, 3, 3.5, 2, 0.45, 4, 1, 0, 0, 0, 0, -1, 1, 85, 0, 0);
	CfgPowerClass(59, 600, 100, 100, 30, 2000, 200, 300, 1, 0.25, 1, 1, 1, 1, 0.75, 3, 3, 2.75, 2, 0.5, 4, 1, 0, 0, 0, 0, -1, 1, 85, 0, 0);
	CfgPowerClass(60, 500, 100, 120, 30, 2500, 200, 300, 1.1, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 2, 2, 0.6, 4, 1, 0, 0, 0, 0, 0, 0, 50, 0, 0);
	CfgPowerClass(61, 500, 100, 135, 40, 2750, 200, 300, 1.5, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 3, 2, 0.35, 4, 1, 0, 0, 0, 0, 1, -1, 40, 0, 0);
	CfgPowerClass(62, 500, 100, 135, 40, 2750, 200, 300, 1.3, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 2.7, 2, 0.35, 2, 1, 0, 0, 0, 0, 1, -1, 40, 0, 0);
	CfgPowerClass(64, 500, 100, 135, 40, 2750, 200, 300, 1.3, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 3, 2, 0.35, 3, 1, 0, 0, 0, 0, 1, -1, 35, 0, 0);
	CfgPowerClass(65, 500, 100, 120, 30, 2500, 200, 300, 1.2, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 2, 2, 0.5, 4, 1, 0, 0, 0, 0, 0, 0, 65, 0, 0);
	CfgPowerClass(66, 600, 100, 100, 30, 2000, 200, 300, 1, 0.25, 1, 1, 1, 1, 0.75, 3, 3, 2.75, 2, 0.5, 4, 1, 0, 0, 0, 0, -1, 1, 75, 0, 0);
	CfgPowerClass(63, 500, 100, 120, 30, 2750, 200, 300, 1.2, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 2, 2, 0.6, 4, 1, 0, 0, 0, 0, 0, 0, 65, 0, 0);
	
	BaseChanceToBlock=40;
	
	CfgBreakAndEnterDelay(15);
	
	CfgCrimeResponders(2, 2);
	CfgCrimeResponders(1, 2);
	CfgCrimeResponders(0, 1);
	CfgCrimeResponders(8, 1);
	CfgCrimeResponders(10, 1);
	CfgCrimeResponders(11, 1);
	CfgCrimeResponders(13, 1);
	...
	CfgPowerClass(9, 600, 90, 40, 4, 1600, 100, 100, 0.75, 0.4, 0.25, 0.01, 5, 2, 0.65, 3, 4, 2, 6, 0.9, 2, 1, 0, 1, 0, 1, 0, 0, 75, 0, 0);
	...
	CfgPowerClass(28, 240, 50, 95, 25, 2000, 500, 750, 5, 0.5, 0.9, 0.5, 4.5, 1.5, 0.6, 5.5, 5.5, 2, 2, 0.48, 4, 1, 0, 1, 0, 0, 0, 0, 95, 0, 0);
	...
	CfgPowerClass(54, 300, 60, 55, 15, 1750, 500, 750, 2.5, 0.38, 0.8, 0.4, 4, 1.5, 0.65, 5, 5, 3, 3, 0.16, 4, 1, 1, 1, 0, 0, -1, 1, 90, 0, 0);
