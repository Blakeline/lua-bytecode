function CfgDifficulty()
	...
	CfgWarriorClass(0, 100, 115, 150, 202, 110, 170, 1, 3, 3, 3, 3, 1, 2);
	CfgWarriorClass(1, 100, 115, 120, 162, 100, 168, 1, 3, 2, 2, 3, 1, 2);
	CfgWarriorClass(2, 100, 115, 120, 162, 100, 168, 2, 2, 3, 2, 2, 1, 2);
	CfgWarriorClass(3, 100, 115, 120, 156, 80, 156, 3, 1, 2, 1, 2, 3, 1);
	CfgWarriorClass(4, 100, 115, 150, 144, 100, 240, 3, 1, 2, 1, 2, 3, 2);
	CfgWarriorClass(5, 100, 115, 100, 144, 90, 240, 2, 3, 3, 3, 1, 2, 2);
	CfgWarriorClass(6, 100, 115, 78, 144, 200, 240, 3, 1, 1, 1, 2, 3, 2);
	CfgWarriorClass(7, 100, 115, 120, 156, 100, 168, 1, 2, 3, 2, 1, 1, 2);
	CfgWarriorClass(8, 100, 115, 96, 144, 70, 132, 1, 3, 3, 3, 2, 1, 2);
	...
	CfgPowerClass(9, 600, 90, 45, 5, 2500, 100, 100, 1.5, 0.35, 0.25, 0.01, 5, 1.5, 0.65, 4, 4, 2, 1, 0.4, 3, 1, 0, 1, 0, 0, 0, 0, 75, 0, 0);
	...
	CfgPowerClass(26, 240, 50, 95, 25, 2000, 500, 750, 1, 0.5, 0.75, 0.4, 4.5, 1.5, 0.6, 2.5, 2.5, 2, 2, 0.48, 4, 1, 0, 1, 0, 0, 0, 0, 95, 0, 0);
	CfgPowerClass(28, 240, 50, 95, 25, 2000, 500, 750, 3, 0.5, 0.9, 0.5, 4.5, 1.5, 0.6, 5.5, 5.5, 2, 2, 0.48, 4, 1, 0, 1, 0, 0, 0, 0, 95, 0, 0);
	...
	CfgChar(1, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_cl", "none", 0, 0, RangeNormal, "none", 0, "none");
	CfgChar(2, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_cl_gen", "none", 0, 0, RangeNormal, "none", 0, "none");
	CfgChar(3, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_cl_ghost", "none", 0, 0, RangeNormal, "none", 5, "none");
	CfgChar(4, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_cl_chase", "none", 0, 0, RangeNormal, "none", 0, "none");
	CfgChar(5, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_sw", "none", 1, 0, RangeNormal, "none", 0, "none");
	CfgChar(6, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_sw_gen", "none", 1, 0, RangeNormal, "none", 0, "none");
	CfgChar(7, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_sw_cv", "none", 1, 0, RangeNormal, "none", 0, "none");
	CfgChar(8, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_sw_ghost", "none", 1, 0, RangeNormal, "none", 0, "none");
	CfgChar(9, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_sw_chase", "none", 1, 0, RangeNormal, "none", 0, "none");
	CfgChar(11, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_aj", "none", 2, 0, RangeNormal, "none", 0, "none");
	CfgChar(12, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_aj_gen", "none", 2, 0, RangeNormal, "none", 0, "none");
	CfgChar(13, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_aj_cv", "none", 2, 0, RangeNormal, "none", 0, "none");
	CfgChar(14, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_aj_ghost", "none", 2, 0, RangeNormal, "none", 0, "none");
	CfgChar(15, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_co", "none", 3, 0, RangeNormal, "none", 0, "none");
	CfgChar(16, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_co_gen", "none", 3, 0, RangeNormal, "none", 0, "none");
	CfgChar(17, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_co_cv", "none", 3, 0, RangeNormal, "none", 0, "none");
	CfgChar(18, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_cb", "dyn_warr_cb", 4, 0, RangeNormal, "none", 0, "none");
	CfgChar(19, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_cb_gen", "dyn_warr_cb", 4, 0, RangeNormal, "none", 0, "none");
	CfgChar(20, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_cb_cv", "dyn_warr_cb", 4, 0, RangeNormal, "none", 0, "none");
	CfgChar(21, 3, 14, 2, 8, 600, DamageFox, Att_Warrior, 1, "warr_fo", "none", 5, 0, RangeNormal, "none", 0, "none");
	CfgChar(22, 3, 14, 2, 8, 600, DamageFox, Att_Warrior, 1, "warr_fo_gen", "none", 5, 0, RangeNormal, "none", 0, "none");
	CfgChar(23, 3, 14, 2, 8, 600, DamageFox, Att_Warrior, 1, "warr_fo_cv1", "none", 5, 0, RangeNormal, "none", 0, "none");
	CfgChar(24, 3, 14, 2, 8, 600, DamageFox, Att_Warrior, 1, "warr_fo_cv2", "none", 5, 0, RangeNormal, "none", 0, "none");
	CfgChar(25, 3, 14, 2, 8, 600, DamageFox, Att_Warrior, 1, "warr_fo_ghost", "none", 5, 0, RangeNormal, "none", 5, "none");
	CfgChar(26, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_ve", "none", 6, 0, RangeNormal, "none", 0, "none");
	CfgChar(27, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_ve_gen", "none", 6, 0, RangeNormal, "none", 0, "none");
	CfgChar(28, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_ve", "none", 6, 0, RangeNormal, "none", 0, "none");
	CfgChar(29, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_ve_cv", "none", 6, 0, RangeNormal, "none", 0, "none");
	CfgChar(30, 3, 14, 2, 8, 600, DamageFox, Att_Warrior, 1, "warr_re", "none", 7, 0, RangeNormal, "none", 0, "none");
	CfgChar(31, 3, 14, 2, 8, 600, DamageFox, Att_Warrior, 1, "warr_re_gen", "none", 7, 0, RangeNormal, "none", 0, "none");
	CfgChar(32, 3, 14, 2, 8, 600, DamageFox, Att_Warrior, 1, "warr_re_cv", "none", 7, 0, RangeNormal, "none", 0, "none");
	CfgChar(33, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_sn", "none", 8, 0, RangeNormal, "none", 0, "none");
	CfgChar(34, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_sn_gen", "none", 8, 0, RangeNormal, "none", 5, "none");
	CfgChar(35, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_sn_cv", "none", 8, 0, RangeNormal, "none", 0, "none");
	CfgChar(36, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_sn_chase", "none", 8, 0, RangeNormal, "none", 0, "none");
	CfgChar(38, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_ty", "none", 9, 0, RangeNormal, "none", 0, "none");
	CfgChar(40, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_ty_cv", "none", 9, 0, RangeNormal, "none", 0, "none");
	CfgChar(41, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_jn", "none", 13, 0, RangeNormal, "none", 0, "none");
	CfgChar(43, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_ma", "none", 10, 0, RangeNormal, "none", 0, "none");
	CfgChar(45, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_ly", "none", 11, 0, RangeNormal, "none", 0, "none");
	CfgChar(189, 3, 14, 2, 6, 600, DamageWarriors, Att_Warrior, 1, "dest_cl", "dyn_dest_lt", 0, 0, RangeNormal, "none", 5, "none");
	CfgChar(191, 3, 14, 2, 6, 600, DamageWarriors, Att_Warrior, 1, "dest_ve", "none", 6, 0, RangeNormal, "none", 5, "none");
	CfgChar(49, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_so_va1", "none", 10, 0, RangeNormal, "none", 0, "none");
	CfgChar(50, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_so_va2", "none", 14, 0, RangeNormal, "none", 0, "none");
	CfgChar(51, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_so_va3", "none", 13, 0, RangeNormal, "none", 0, "none");
	CfgChar(52, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_so_vb1", "none", 11, 0, RangeNormal, "none", 0, "none");
	CfgChar(53, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_so_vb2", "none", 12, 0, RangeNormal, "none", 0, "none");
	CfgChar(54, 3, 14, 2, 7, 600, DamageWarriors, Att_Warrior, 1, "warr_so_vb3", "none", 11, 0, RangeNormal, "none", 0, "none");
	...
	CfgChar(89, 2, 13, 1, 27, 2000, DamageGhost, Att_FuryBoss, 1, "fury_bo", "none", 50, 0, RangeNormal, "none", 0, "dyn_lt_bat_blk_a");
	...
	CfgChar(95, 2, 12, 1, 28, 600, DamageTough, Att_FuryKill, 1, "fury_so2", "none", 51, 0, RangeNormal, "dyn_revival", 50, "none");
