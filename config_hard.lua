function CfgDifficulty()
	...
	CfgWarriorClass(0, 45, 119, 150, 202, 140, 195, 1, 3, 3, 3, 3, 1, 2);
	CfgWarriorClass(1, 45, 111, 120, 162, 140, 190, 1, 3, 2, 2, 3, 1, 2);
	CfgWarriorClass(2, 35, 102, 120, 162, 135, 190, 2, 2, 3, 2, 2, 1, 2);
	CfgWarriorClass(3, 30, 85, 120, 160, 120, 175, 3, 1, 2, 1, 2, 3, 1);
	CfgWarriorClass(4, 30, 85, 150, 144, 130, 240, 3, 1, 2, 1, 2, 3, 2);
	CfgWarriorClass(5, 45, 94, 100, 144, 125, 240, 2, 3, 3, 3, 1, 2, 2);
	CfgWarriorClass(6, 30, 85, 78, 144, 200, 240, 3, 1, 1, 1, 2, 3, 2);
	CfgWarriorClass(7, 40, 102, 120, 156, 125, 195, 1, 2, 3, 2, 1, 1, 2);
	CfgWarriorClass(8, 45, 111, 96, 144, 145, 200, 1, 3, 3, 3, 2, 1, 2);
	
	CfgPowerClass(58, 550, 110, 80, 20, 2000, 200, 300, 1, 0.25, 1, 1, 1, 1, 0.75, 3, 3, 3.5, 2, 0.45, 4, 1, 0, 0, 0, 0, -1, 1, 85, 0, 0);
	CfgPowerClass(59, 500, 100, 100, 30, 2000, 200, 300, 0.85, 0.25, 1, 1, 1, 1, 0.75, 3, 3, 2.75, 2, 0.5, 4, 1, 0, 0, 0, 0, -1, 1, 85, 0, 0);
	CfgPowerClass(60, 400, 100, 120, 30, 2500, 200, 300, 0.9, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 2, 2, 0.6, 4, 1, 0, 0, 0, 0, 0, 0, 50, 0, 0);
	CfgPowerClass(61, 400, 60, 135, 40, 2750, 200, 300, 1.1, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 3, 2, 0.35, 4, 1, 0, 0, 0, 0, 1, -1, 40, 0, 0);
	CfgPowerClass(62, 400, 75, 135, 40, 2750, 200, 300, 1.05, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 2.7, 2, 0.35, 2, 1, 0, 0, 0, 0, 1, -1, 40, 0, 0);
	CfgPowerClass(64, 400, 60, 135, 40, 2750, 200, 300, 1.1, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 3, 2, 0.35, 3, 1, 0, 0, 0, 0, 1, -1, 35, 0, 0);
	CfgPowerClass(65, 400, 100, 120, 30, 2500, 200, 300, 1, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 2, 2, 0.5, 4, 1, 0, 0, 0, 0, 0, 0, 65, 0, 0);
	CfgPowerClass(66, 500, 100, 100, 30, 2000, 200, 300, 0.8, 0.25, 1, 1, 1, 1, 0.75, 3, 3, 2.75, 2, 0.5, 4, 1, 0, 0, 0, 0, -1, 1, 75, 0, 0);
	CfgPowerClass(63, 400, 100, 120, 30, 2750, 200, 300, 1, 0.3, 1, 1, 1, 1, 0.75, 3, 3, 2, 2, 0.6, 4, 1, 0, 0, 0, 0, 0, 0, 65, 0, 0);
	...
	DamageNormal={25, 16, 50, 41, 41, 32, 57, 48, 57, 48, 20, 15, 15, 15, 15, 30, 65, 0, 65, 30, 30, 0, 0, 0, 40, 50, 55, 50, 60, 100, 0, 0, 45, 45, 0, 40, 0, 65, 60, 60, 0, 0, 45, 0, 0};
	...
	CfgPowerClass(0, 180, 30, 80, 10, 2500, 750, 750, 0.54, 0.45, 0.025, 0, 3.5, 1.5, 0.5, 7, 7, 5, 0, 0, 4, 0, 0, 0, 1, 0, 0, 0, 30, 0, 0);
	CfgPowerClass(1, 200, 30, 95, 20, 2250, 750, 750, 0.72, 0.1, 0.1, 0.05, 3, 1.25, 0.5, 6, 6, 4, 0, 0.04, 4, 0, 0, 0, 1, 0, 0, 0, 45, 0, 0);
	CfgPowerClass(2, 200, 32, 95, 20, 2000, 750, 750, 0.78, 0.25, 0.35, 0.15, 3, 1.25, 0.55, 6, 6, 4, 0, 0.25, 4, 1, 0, 0, 0, 0, 0, 0, 50, 0, 0);
	CfgPowerClass(3, 240, 42, 95, 25, 2000, 750, 750, 0.84, 0.15, 0.6, 0.3, 3, 1.5, 0.6, 5, 5, 3, 0, 0.32, 4, 1, 0, 0, 0, 0, 0, 0, 75, 0, 0);
	CfgPowerClass(4, 240, 50, 95, 25, 2000, 500, 750, 0.84, 0.2, 0.75, 0.4, 4.5, 1.5, 0.6, 5.5, 5.5, 2, 2, 0.48, 4, 1, 1, 1, 0, 0, 0, 0, 75, 0, 0);
	CfgPowerClass(5, 300, 60, 95, 25, 1750, 500, 750, 0.96, 0.25, 0.9, 0.5, 4, 1.5, 0.65, 5, 5, 2, 3, 0.48, 4, 1, 1, 1, 0, 0, 0, 0, 90, 0, 0);
	...
	CfgPowerClass(9, 600, 90, 50, 5, 1200, 100, 50, 1.3, 0.2, 0.25, 0.01, 5, 1.5, 0.65, 3, 4, 1.5, 8, 0.9, 2, 1, 0, 1, 0, 1, 0, 0, 75, 0, 0);
	...
	CfgPowerClass(47, 200, 30, 95, 20, 2250, 300, 300, 0.72, 0.1, 0.45, 0.35, 1, 1.25, 0.5, 7, 7, 5, 5, 0.04, 4, 1, 0, 1, 0, 1, 0, 0, 60, 0, 0);
	...
	CfgPowerClass(50, 240, 50, 95, 25, 2000, 500, 750, 1.2, 0.2, 0.75, 0.4, 4.5, 1.5, 0.6, 5.5, 5.5, 2, 2, 0.48, 4, 1, 1, 1, 0, 0, 0, 0, 75, 1, 0);
	...
	CfgPowerClass(39, 100, 10, 35, 5, 2250, 750, 750, 0.72, 0.1, 0.1, 0.05, 3, 1.25, 0.5, 8, 8, 5, 0, 0.04, 4, 1, 0, 0, 0, 0, 0, 0, 45, 0, 0);
	CfgPowerClass(20, 60, 30, 80, 10, 2500, 750, 750, 0.54, 1, 0.1, 0.1, 5.5, 1.5, 0.5, 25, 25, 5, 0, 0.16, 4, 0, 0, 0, 1, 0, 0, 0, 40, 0, 0);
	CfgPowerClass(24, 240, 50, 55, 15, 2000, 500, 750, 1.2, 0.15, 0.65, 0.35, 4.5, 1.5, 0.6, 5.5, 5.5, 3, 2, 0.16, 4, 1, 1, 1, 0, 0, -1, 0, 75, 0, 0);
	CfgPowerClass(25, 300, 60, 55, 15, 1750, 500, 750, 1.44, 0.18, 0.8, 0.4, 4, 1.5, 0.65, 5, 5, 3, 3, 0.16, 4, 1, 1, 1, 0, 0, -1, 1, 90, 0, 0);
	CfgPowerClass(16, 180, 30, 80, 10, 2500, 750, 750, 0.54, 0.1, 0.025, 0, 3.5, 1.5, 0.5, 6, 0.01, 4, 0, 0, 4, 0, 0, 0, 1, 0, 0, 0, 35, 0, 0);
	...
	CfgPowerClass(18, 200, 32, 95, 20, 2000, 750, 750, 0.78, 0.15, 0.4, 0.3, 3, 1.25, 0.55, 6, 6, 4, 0, 0.32, 4, 1, 0, 0, 0, 0, 0, 0, 60, 0, 0);
	CfgPowerClass(19, 240, 42, 95, 25, 2000, 750, 750, 0.84, 0.15, 0.6, 0.3, 3, 1.5, 0.6, 5, 5, 3, 0, 0.32, 4, 1, 0, 1, 0, 1, 0, 0, 75, 0, 0);
	CfgPowerClass(55, 240, 50, 95, 25, 2000, 500, 750, 0.84, 0.2, 0.75, 0.4, 4.5, 1.5, 0.6, 5.5, 5.5, 2, 2, 0.48, 4, 1, 1, 1, 0, 0, 0, 0, 75, 0, 1);
	CfgPowerClass(31, 240, 32, 55, 15, 2000, 500, 750, 0.84, 0.2, 0.9, 0.5, 4.5, 1.5, 0.6, 5.5, 5.5, 3, 2, 0.16, 4, 1, 1, 1, 0, 0, 0, 1, 70, 0, 0);
	...
	CfgChar(89, 2, 13, 1, 27, 2600, DamageGhost, Att_FuryBoss, 1, "fury_bo", "none", 50, 0, RangeNormal, "none", 0, "dyn_lt_bat_blk_a");
